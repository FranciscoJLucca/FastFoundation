...
class Constants {
    ...
    @State static var projects: [Project] = [
        ...
        Project(name: "Project Manager",
                description: "Project to develop a tool to manage proects in a controlled enviroment",
                members:"João, Marina, Francisco, Victor",
                icon:"doc.text",
                admin: true,
                creator:"joaofleao",
                engage: Engage(bigIdea:"Business",
                               essentialQuestion:"Why do people keep their dektop unorganized",
                               challenge:"How to make people organize their desktop",
                               annotations:""),
                investigate: Investigate(guidingQuestions:["question1", "question2", "question3"],
                                         resources:[],
                                         activities:[],
                                         annotations:""),
                act:Act(annotations:"")
